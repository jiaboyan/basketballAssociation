...
<!-- Font Awesome -->
<link rel="stylesheet" href="${ctxPath}/bootstrap/css/font-awesome.min.css">
<!-- Ionicons -->
<link rel="stylesheet" href="${ctxPath}/bootstrap/css/ionicons.min.css">
<!-- Theme style -->
...
<!-- iCheck -->
<link rel="stylesheet" href="${ctxPath}/plugins/iCheck/flat/blue.css">
<!-- Morris chart -->
...
<link rel="stylesheet" href="${ctxPath}/bootstrap-fileUpload/css/fileinput.min.css">
