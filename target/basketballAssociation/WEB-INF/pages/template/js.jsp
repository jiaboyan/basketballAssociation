...
<!-- Morris.js charts -->
<script src="${ctxPath}/plugins/morris/raphael-min.js"></script>
...
<!-- AdminLTE App -->
<script src="${ctxPath}/dist/js/app.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="${ctxPath}/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="${ctxPath}/dist/js/demo.js"></script>

<script src="${ctxPath}/bootstrap-fileUpload/js/fileinput.min.js"></script>

<script src="${ctxPath}/bootstrap-fileUpload/js/zh.min.js"></script>

<script src="${ctxPath}/jquery-fileUpload/js/jquery.ajaxfileupload.js"></script>
